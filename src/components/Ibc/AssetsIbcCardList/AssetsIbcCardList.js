									...
									<td>
										{_.isNil(item?.channelId) ? (
											...
											<>
												...
												<div className={cx("item-link")}>{item.channelId}</div>
											</>
										)}
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										...
										{_.isNil(item?.prices) ? (
											...
											<div className={cx("item-text")}>{formatNumber(item?.prices?.supply)}</div>
										)}
									</td>
								</tr>
								...
								<tr>
									<td colSpan={2}>
										...
										{_.isNil(item?.prices) ? (
											...
											<div className={cx("item-text")}>{formatNumber(item?.prices?.TotalValue)}</div>
										)}
									</td>
								</tr>
							</tbody>
