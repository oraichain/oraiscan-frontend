	...
	const MobileFooter = () => {
		return (
			<>
				...
				<div className={cx("footer-mobile")}>
					<div className={cx("left")}>
						<div className={cx("subpage")}>Subpage</div>
						<div className={cx("subpage-link")}>aiVault</div>
						<div className={cx("subpage-link")}>aiMetric</div>
						<div className={cx("subpage-link")}>aiTracking</div>
					</div>
					<div className={cx("right")}>
						<div className={cx("subpage")}>Subpage</div>
						<div className={cx("subpage-link")}>
		...
		<div className={cx("footer")}>
			...
			{isDesktop && (
				<div className={cx("footer-bottom")}>
					<Container fixed>
						<div className={cx("content")}>
							<div className={cx("copyright")}>©2021 Oraichain Pte. Ltd. All rights reserved. Privacy Policy Customer Support</div>
							<ul className={cx("nav")}>
								<li className={cx("nav-item")}>
