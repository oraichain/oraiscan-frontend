...
import styles from "./OracleScriptDetailTable.scss";

const cx = classNames.bind(styles);
const headerCells = ["Requests", "Oracle Script", "Report Status", "Status", "Owner"];
const OracleScriptDetailTable = memo(({dataSources, pages, onPageChange}) => {
...
OracleScriptDetailTable.defaultProps = {
	dataSources: [
		{
			request: "xxx",
			oracleScript: "xxx",
...
export default OracleScriptDetailTable;
