	...
	return (
		<>
			...
			<div className={cx("card-body")}>
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CREATE_VALIDATOR, txTypes.COSMOS_SDK_MIGRATE.MSG_CREATE_VALIDATOR]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_DELEGATE, txTypes.COSMOS_SDK_MIGRATE.MSG_DELEGATE]) && (
					<>
						{getAddressRow("Delegator Address", value?.delegator_address, value?.delegator_address_tag)}
						{getAddressRow("Validator Address", value?.validator_address)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_UNDELEGATE, txTypes.COSMOS_SDK_MIGRATE.MSG_UNDELEGATE]) && (
					<>
						{getAddressRow("Delegator Address", value?.delegator_address, value?.delegator_address_tag)}
						{getAddressRow("Validator Address", value?.validator_address)}
						{getCurrencyRowFromObject("Amount", value?.amount)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_SEND, txTypes.COSMOS_SDK_MIGRATE.MSG_SEND]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_MULTI_SEND, txTypes.COSMOS_SDK_MIGRATE.MSG_MULTI_SEND]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_EDIT_VALIDATOR, txTypes.COSMOS_SDK_MIGRATE.MSG_EDIT_VALIDATOR]) && (
					<>
						{getAddressRow("Validator Address", value?.validator_address)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_WITHDRAW_DELEGATOR_REWARD, txTypes.COSMOS_SDK_MIGRATE.MSG_WITHDRAW_DELEGATOR_REWARD]) && (
					<>
						{getAddressRow("Delegator Address", value?.delegator_address, value?.delegator_address_tag)}
						{getAddressRow("Validator Address", value?.validator_address)}
						{getCurrencyRowFromObject("Amount", value?.amount)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_WITHDRAW_VALIDATOR_COMMISSION, txTypes.COSMOS_SDK_MIGRATE.MSG_WITHDRAW_VALIDATOR_COMMISSION]) && (
					<>
						{getAddressRow("Validator Address", value?.validator_address)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_VOTE, txTypes.COSMOS_SDK_MIGRATE.MSG_VOTE]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.INSTANTIATE_CONTRACT, txTypes.COSMOS_SDK_MIGRATE.MSG_VOTE]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.EXECUTE_CONTRACT, txTypes.COSMOS_SDK_MIGRATE.EXECUTE_CONTRACT]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_IBC_TRANSFER, txTypes.COSMOS_SDK_MIGRATE.MSG_IBC_TRANSFER]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_IBC_UPDATE_CLIENT, txTypes.COSMOS_SDK_MIGRATE.MSG_IBC_UPDATE_CLIENT]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_IBC_RECV_PACKET, txTypes.COSMOS_SDK_MIGRATE.MSG_IBC_RECV_PACKET]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.STORE_CODE, txTypes.COSMOS_SDK_MIGRATE.STORE_CODE]) && (
					<>
						{getInfoRow("Code Id", value?.code_id)}
						{getAddressRow("Sender", value?.sender, value?.sender_tag)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_SUBMIT_PROPOSAL, txTypes.COSMOS_SDK_MIGRATE.MSG_SUBMIT_PROPOSAL]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_DEPOSIT, txTypes.COSMOS_SDK_MIGRATE.MSG_DEPOSIT]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_BEGIN_REDELEGATE, txTypes.COSMOS_SDK_MIGRATE.MSG_BEGIN_REDELEGATE]) && (
					<>
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CONNECTION_OPEN_CONFIRM, txTypes.COSMOS_SDK_MIGRATE.MSG_CONNECTION_OPEN_CONFIRM]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CREATE_CLIENT, txTypes.COSMOS_SDK_MIGRATE.MSG_CREATE_CLIENT]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CONNECTION_OPEN_TRY, txTypes.COSMOS_SDK_MIGRATE.MSG_CONNECTION_OPEN_TRY]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Chain ID", value?.client_state?.chain_id)}
						{getInfoRow("Height", value?.client_state?.latest_height?.revision_height)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CHANNEL_OPEN_TRY, txTypes.COSMOS_SDK_MIGRATE.MSG_CHANNEL_OPEN_TRY]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CHANNEL_OPEN_CONFIRM, txTypes.COSMOS_SDK_MIGRATE.MSG_CHANNEL_OPEN_CONFIRM]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Port ID", value?.port_id)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CONNECT_OPEN_INIT, txTypes.COSMOS_SDK_MIGRATE.MSG_CONNECT_OPEN_INIT]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Client ID", value?.client_id)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CONNECTION_OPEN_ACK, txTypes.COSMOS_SDK_MIGRATE.MSG_CONNECTION_OPEN_ACK]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Chain ID", value?.client_state?.chain_id)}
						{getInfoRow("Connection ID", value?.connection_id)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CHANNEL_OPEN_INIT, txTypes.COSMOS_SDK_MIGRATE.MSG_CHANNEL_OPEN_INIT]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Port ID", value?.port_id)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CHANNEL_OPEN_ACK, txTypes.COSMOS_SDK_MIGRATE.MSG_CHANNEL_OPEN_ACK]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Port ID", value?.port_id)}
						{getInfoRow("Channel ID", value?.channel_id)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_CHANNEL_ACKNOWLEDGEMENT, txTypes.COSMOS_SDK_MIGRATE.MSG_CHANNEL_ACKNOWLEDGEMENT]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Sequence", value?.packet.sequence)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_TIMEOUT, txTypes.COSMOS_SDK_MIGRATE.MSG_TIMEOUT]) && (
					<>
						{getAddressRow("Signer", value?.signer)}
						{getInfoRow("Sequence", value?.packet?.sequence)}
				...
				{compareTypeMessage(type, [txTypes.COSMOS_SDK.MSG_MIGRATE_CONTRACT, txTypes.COSMOS_SDK_MIGRATE.MSG_MIGRATE_CONTRACT]) && (
					<>
						{getInfoRow("Code ID", value?.code_id)}
