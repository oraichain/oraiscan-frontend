export default Object.freeze({
	...
	COSMOS_SDK: {
		...
		MSG_MIGRATE_CONTRACT: "/cosmwasm.wasm.v1beta1.MsgMigrateContract",
		MSG_BEGIN_REDELEGATE: "/cosmos.staking.v1beta1.MsgBeginRedelegate",
		MSG_IBC_TRANSFER: "/ibc.applications.transfer.v1beta1.MsgTransfer",
		MSG_IBC_UPDATE_CLIENT: "/ibc.core.client.v1beta1.MsgUpdateClient",
		MSG_IBC_RECV_PACKET: "/ibc.core.channel.v1beta1.MsgRecvPacket",
		MSG_CONNECTION_OPEN_CONFIRM: "/ibc.core.connection.v1beta1.MsgConnectionOpenConfirm",
		MSG_CREATE_CLIENT: "/ibc.core.client.v1beta1.MsgCreateClient",
		MSG_CONNECTION_OPEN_TRY: "/ibc.core.connection.v1beta1.MsgConnectionOpenTry",
		MSG_CHANNEL_OPEN_TRY: "/ibc.core.channel.v1beta1.MsgChannelOpenTry",
		MSG_CHANNEL_OPEN_CONFIRM: "/ibc.core.channel.v1beta1.MsgChannelOpenConfirm",
		MSG_CONNECT_OPEN_INIT: "/ibc.core.connection.v1beta1.MsgConnectionOpenInit",
		MSG_CONNECTION_OPEN_ACK: "/ibc.core.connection.v1beta1.MsgConnectionOpenAck",
	...
	COSMOS_SDK_MIGRATE: {
		...
		MSG_SEND: "/cosmos.bank.v1.MsgSend",
		MSG_MULTI_SEND: "/cosmos.bank.v1.MsgMultiSend",
		MSG_EDIT_VALIDATOR: "/cosmos.staking.v1.MsgEditValidator",
		MSG_WITHDRAW_DELEGATOR_REWARD: "/cosmos.distribution.v1.MsgWithdrawDelegatorReward",
		MSG_WITHDRAW_DELEGATION_REWARD: "/cosmos.distribution.v1.MsgWithdrawDelegatorReward",
		MSG_WITHDRAW_VALIDATOR_COMMISSION: "/cosmos.distribution.v1.MsgWithdrawValidatorCommission",
		MSG_SUBMIT_PROPOSAL: "/cosmos.gov.v1.MsgSubmitProposal",
		MSG_DEPOSIT: "/cosmos.gov.v1.MsgDeposit",
		MSG_VOTE: "/cosmos.gov.v1.MsgVote",
		MSG_CREATE_VALIDATOR_PROPOSAL: "/cosmos.staking.v1.MsgCreateValidatorProposal",
		...
		MSG_BEGIN_REDELEGATE: "/cosmos.staking.v1.MsgBeginRedelegate",
