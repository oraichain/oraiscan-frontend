  ...
  return (
    <div style={{ marginLeft: "16.67%", marginRight: "16.67%" }}>
      <div style={{ display: "flex", flexFlow: "row", height: 30, marginTop: 30, justifyContent: "space-between" }}>
        ...
        <div style={{ ...styles.frameTxt, width: "60%" }}>
        ...
        <div style={{ ...styles.card, width: "33%" }}>
          <div style={{ display: "flex", flexFlow: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 15 }}>
            <div style={{ display: "flex", flexFlow: "row", alignItems: "center" }}>
              <img src={BINANCE_LOGO} />
              <div style={{ ...styles.title, marginLeft: 15 }}>Binance Staking</div>
            </div>
        ...
        <div style={{ ...styles.card, width: "65%" }}>
          <div style={{ display: "flex", flexFlow: "row" }}>
            <div style={{ flex: 6 }}>
              ...
              <div style={{ fontSize: 12, color: "#1B57F0" }}>https://binance.com</div>
            ...
            <div style={{ flex: 7 }}>
              ...
              <div style={{ fontSize: 12 }}>1.899999 ORAI (0.00%)</div>
            </div>
            <div style={{ flex: 8 }}>
      ...
      <div style={{ display: "flex", flexFlow: "row", justifyContent: "space-between", marginBottom: 30 }}>
        <div style={{ ...styles.card, width: "49%" }}>
          <div style={{ display: "flex", flexFlow: "row", justifyContent: "space-between" }}>
            ...
            <div style={{ ...styles.frameTxt, paddingLeft: 10, paddingRight: 10 }}>
              <img src={IC_SHIRT} height={15} width={15} />
              <div style={{ fontSize: 12, marginLeft: 5 }}>1,854 (</div>
              <div style={{ fontSize: 12, color: "#12C90E" }}>7 in 24h</div>
