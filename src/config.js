...
const config = Object.freeze({
	...
	CONTRACT_DEPLOY_API: isTestnet ? process.env.REACT_APP_CONTRACT_API_TESTNET || "https://cosmwasm-verify.testnet.orai.io/api/v1" : process.env.REACT_APP_CONTRACT_API || "https://cosmwasm-verify.orai.io/api/v1",
	walletapi: isTestnet
	...
	AIORACLE_BACKEND: isTestnet ? process.env.REACT_APP_AIORACLE_BACKEND || "https://testnet-aioracle-svr.orai.io" : process.env.REACT_APP_AIORACLE_BACKEND || "https://aioracle-svr.orai.io",
